...
namespace ProAtividade.API.Controllers
{
    ...
    public class AtividadeController : Controller
    {
        ...
        public AtividadeController(ILogger<AtividadeController> logger, IAtividadeService atividadeService)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] Atividade model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] Atividade model)
        {
            try
            {
                if (model.Id != id) return this.StatusCode(StatusCodes.Status409Conflict,
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                if (atividade == null) return this.StatusCode(StatusCodes.Status409Conflict,
